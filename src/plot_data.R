...
png(outfile_source_test, width=2000, height=2000, bg="transparent")
...
png(outfile_target_test, width=2000, height=2000, bg="transparent")
...
png(outfile_source_celltype, width=2000, height=2000, bg="transparent")
...
png(outfile_target_celltype, width=2000, height=2000, bg="transparent")
