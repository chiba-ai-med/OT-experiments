...
# DATASETS = ['large_posneg', 'large_negpos',
	# 'sma_pos_trs', 'sma_neg_trs',
	# 'sma_trs_pos', 'sma_trs_neg',
	# 'public_pos_trs', 'public_neg_trs',
	# 'public_trs_pos', 'public_trs_neg']
# DATASETS = ['large_posneg', 'large_negpos']
DATASETS = ['large_posneg']
# LTLRGW_PARAMETERS = ['1E+8','1E+9','1E+10','1E+11','1E+12','1E+13','1E+14']
LTLRGW_PARAMETERS = ['1E+11']
QGW_PARAMETERS = ['1E+8','1E+9','1E+10','1E+11','1E+12','1E+13','1E+14']
CGW_PARAMETERS = ['1E+8','1E+9','1E+10','1E+11','1E+12','1E+13','1E+14']
...
rule all:
	input:
		...
		expand('plot/{data}/target_train_data_finish',
			data=DATASETS),
		expand('plot/{data}/ltlrgw/{ltlrgwp}/finish',
			data=DATASETS, ltlrgwp=LTLRGW_PARAMETERS),
		expand('plot/{data}/qgw/{qgwp}/finish',
			data=DATASETS, qgwp=QGW_PARAMETERS),
...
rule preprocess:
	...
	shell:
		'src/preprocess_{wildcards.data}.sh {output} >& {log}'
...
#################################
# Linear-Time Low-rank Gromov-Wasserstein
#################################
rule ltlrgw:
	input:
		'data/{data}/source_test_data.txt',
		...
		'data/{data}/source_celltype.txt'
	output:
		'output/{data}/ltlrgw/{ltlrgwp}/plan.pkl',
		'output/{data}/ltlrgw/{ltlrgwp}/test_transported.txt',
		'output/{data}/ltlrgw/{ltlrgwp}/train_transported.txt',
		'output/{data}/ltlrgw/{ltlrgwp}/celltype_transported.txt'
	container:
		'docker://koki/ot-experiments:20240719'
	resources:
		mem_gb=500
	benchmark:
		'benchmarks/{data}_ltlrgw_{ltlrgwp}.txt'
	log:
		'logs/{data}_ltlrgw_{ltlrgwp}.log'
	shell:
		'src/ltlrgw.sh {input} {output} {wildcards.ltlrgwp} >& {log}'
...
rule qgw:
	input:
		...
		'data/{data}/source_celltype.txt'
	output:
		'output/{data}/qgw/{qgwp}/plan.pkl',
		'output/{data}/qgw/{qgwp}/test_transported.txt',
		'output/{data}/qgw/{qgwp}/train_transported.txt',
		'output/{data}/qgw/{qgwp}/celltype_transported.txt'
	container:
		'docker://koki/ot-experiments:20240719'
	resources:
		mem_gb=500
	benchmark:
		'benchmarks/{data}_qgw_{qgwp}.txt'
	log:
		'logs/{data}_qgw_{qgwp}.log'
	shell:
...
rule plot_ltlrgw:
	input:
		...
		'output/{data}/ltlrgw/{ltlrgwp}/celltype_transported.txt'
	output:
		'plot/{data}/ltlrgw/{ltlrgwp}/finish'
	container:
		'docker://koki/ot-experiments-r:20240627'
	benchmark:
		'benchmarks/plot_ot_{data}_ltlrgw_{ltlrgwp}.txt'
	log:
		'logs/plot_ot_{data}_ltlrgw_{ltlrgwp}.log'
	shell:
		'src/plot_ltlrgw_large.sh {input} {output} >& {log}'
...
rule plot_qgw:
	input:
		...
		'output/{data}/qgw/{qgwp}/celltype_transported.txt'
	output:
		'plot/{data}/qgw/{qgwp}/finish'
	container:
		'docker://koki/ot-experiments-r:20240627'
	benchmark:
		'benchmarks/plot_ot_{data}_qgw_{qgwp}.txt'
	log:
		'logs/plot_ot_{data}_qgw_{qgwp}.log'
	shell:
		'src/plot_qgw_large.sh {input} {output} >& {log}'
...
rule plot_svd:
	...
	shell:
		'src/plot_svd_large.sh {input} {output} >& {log}'
...
rule plot_nmf:
	...
	shell:
		'src/plot_ot_large_factor.sh {input} {output} >& {log}'
...
rule plot_accuracy:
	...
	shell:
		'src/plot_accuracy.sh {input} {output} >& {log}'
